            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link active">
                        ...
                        <span style="font-weight: 600; "  class="active">Product</span>
                    </a>
                </li>
                <li class="sidebar-item">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($row['image_url']): ?>
                                            <img src="<?php echo $row['image_url']; ?>" alt="Product Image" style="max-width: 100px;">
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo $row['price']; ?></td>
                                    <td><a href="<?php echo $row['detail_url']; ?>" target="_blank">Detail</a></td>
                                    <td><a href="<?php echo $row['quick_view_url']; ?>" target="_blank">Quick View</a></td>
                                    <td class="btn-action">
